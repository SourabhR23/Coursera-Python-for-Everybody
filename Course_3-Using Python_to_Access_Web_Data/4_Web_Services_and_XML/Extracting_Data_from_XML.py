...
prompt for a URL, read the XML data from that URL using urllib and then parse and extract the comment counts from the XML 
data, compute the sum of the numbers in the file.
...
Actual data: http://py4e-data.dr-chuck.net/comments_565585.xml (Sum ends with 13)
